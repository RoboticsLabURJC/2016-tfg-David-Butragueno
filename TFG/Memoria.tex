...
Dentro de \textit{Detection Suite} existen varias herramientas para realizar mediciones de modelos entrenados. En este caso, se utilizará la herramienta llamada \textit{Automatic Evaluator}\footnote{\url{https://github.com/JdeRobot/DetectionSuite/wiki/Automatic-Evaluation}}.
