...
Tras esto, se puede comenzar con la evaluación de los modelos. Cuando finaliza la ejecución, se muestra por terminal el \acrshort{mAP} y \acrshort{mAR} conjunto para todas las clases utilizando los 10 umbrales comentados anteriormente del \acrshort{IoU}. Además, se muestra el \acrshort{mAP} y \acrshort{mAR} medio de estos umbrales.
