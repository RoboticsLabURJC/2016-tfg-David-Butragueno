...
\renewcommand{\acronymname}{Acronimos}
...
En este apartado se procederá a realizar las pruebas necesarias para evaluar la calidad con la que detectan objetos los modelos comentados durante la memoria. Las redes entrenadas que se medirán, serán las 2 preentrenadas con las bases de datos PascalVoc y Coco, enunciadas en el apartado \ref{SSDCaffe}, y la entrenada utilizando una base de datos personalizada explicada en el apartado \ref{DetectorObjetosSection}.\\

Para medir las prestaciones de cada uno de los modelos, se va a utilizar la herramienta \textit{Detection Suite}\footnote{\url{https://github.com/JdeRobot/dl-DetectionSuite}} de JdeRobot, comentada en el apartado \ref{AntecedentesJdeRobot}. Esta herramienta permite la utilización de varias bases de datos, entre las que se encuentran las utilizadas durante este trabajo, PascalVoc y COCO, además de varios frameworks para el aprendizaje profundo, incluyendo Caffe.\\

Como datos de entrada para medir el rendimiento de los modelos, con \textit{Detection Suite} se pueden utilizar un banco de imágenes con sus respectivas anotaciones, vídeos grabados o las imágenes que capta una cámara en tiempo real. Para este caso, se decidió utilizar un \textit{testing set} formado por imágenes junto con sus anotaciones. Lo más importante, es que estás imágenes seleccionadas no hayan sido utilizadas para entrenar ninguno de los modelos que se compararán, ya que esto falsearía las medidas obtenidas. En el repositorio de la técnica SSD\footnote{\url{https://github.com/weiliu89/caffe/tree/ssd}}, en el apartado \textbf{Preparation}, hay un enlace para descargarse varias imágenes junto con sus anotaciones del conjunto de test de la base de datos PascalVoc. Este banco de ejemplos está formado por 4952 imágenes en los que hay etiquetados 14976 objetos de 20 clases diferentes. En la figura \ref{testImages} se puede observar como están distribuidos los 14976 objetos mencionados anteriormente en cada una de las clases existentes:
